  ...
  return (
    <div className="min-h-screen bg-ds-primary py-8 sm:py-12">
      <div className="container-custom max-w-4xl">
        ...
        {/* Header */}
        <div className="border border-ds-border bg-ds-surface rounded-2xl shadow-sm p-6 sm:p-10 mb-6">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0">
              <Shield className="w-6 h-6 text-green-600" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-ds-text-primary">Privacy Policy</h1>
              <p className="text-sm text-ds-text-secondary mt-1">Last updated: {lastUpdated}</p>
            </div>
          </div>
        ...
        {/* Content */}
        <div className="border border-ds-border bg-ds-surface rounded-2xl shadow-sm p-6 sm:p-10 space-y-8">
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">1. Information We Collect</h2>
            <div className="space-y-4 text-ds-text-secondary leading-relaxed">
              <div>
                <h3 className="font-semibold text-ds-text-primary mb-2">Personal Information</h3>
              ...
              <div>
                <h3 className="font-semibold text-ds-text-primary mb-2">Usage Information</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">2. How We Use Your Information</h2>
            <ul className="list-disc list-inside space-y-2 ml-4 text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">3. Information Sharing</h2>
            <p className="text-ds-text-secondary leading-relaxed mb-4">
              We do not sell, rent, or trade your personal information to third parties. We may share your information with:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4 text-ds-text-secondary">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">4. Cookies</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">5. Data Security</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">6. Data Retention</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">7. Your Rights</h2>
            <p className="text-ds-text-secondary leading-relaxed mb-4">You have the right to:</p>
            <ul className="list-disc list-inside space-y-2 ml-4 text-ds-text-secondary">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">8. Children&apos;s Privacy</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">9. Changes to This Policy</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">10. Contact Us</h2>
            <p className="text-ds-text-secondary leading-relaxed">
        ...
        {/* Bottom Links */}
        <div className="mt-6 text-center text-sm text-ds-text-secondary">
          <p>
            Also read our{' '}
            <Link href="/terms" className="text-ds-accent hover:underline font-medium">Terms & Conditions</Link>
            {' '}and{' '}
            <Link href="/shipping-returns" className="text-ds-accent hover:underline font-medium">Shipping & Returns Policy</Link>
          </p>
        </div>
      </div>
    </div>
