      ...
      <div className="container-custom max-w-4xl">
        ...
        <div className="border border-ds-border bg-ds-surface rounded-2xl shadow-sm p-6 sm:p-10 mb-6">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-ds-surface rounded-xl flex items-center justify-center flex-shrink-0">
              <FileText className="w-6 h-6 text-ds-accent" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-ds-text-primary">Terms & Conditions</h1>
        ...
        <div className="border border-ds-border bg-ds-surface rounded-2xl shadow-sm p-6 sm:p-10 space-y-8">
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">1. Acceptance of Terms</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">2. Use of the Platform</h2>
            <div className="space-y-3 text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">3. Product Information</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">4. Orders and Payment</h2>
            <div className="space-y-3 text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">5. Shipping and Delivery</h2>
            <div className="space-y-3 text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">6. Returns and Refunds</h2>
            <div className="space-y-3 text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">7. Intellectual Property</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">8. Limitation of Liability</h2>
            <p className="text-ds-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-ds-text-primary mb-4">9. Governing Law</h2>
            <p className="text-ds-text-secondary leading-relaxed">
        ...
        <div className="mt-6 text-center text-sm text-ds-text-secondary">
          <p>
            Also read our{' '}
            <Link href="/privacy" className="text-ds-accent hover:underline font-medium">Privacy Policy</Link>
            {' '}and{' '}
